        ...
        <header class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <form class="d-flex position-absolute end-0 pe-2" name="frmSearch" action="search.php" method="GET">
                        <input class="form-control me-2" type="text" name="title" id="title" placeholder="Pesquisar notícias por título" required>
